...
from . import metrics  # TAMARIND VENDOR EDIT: was `from molpal.acquirer import metrics`.
# The absolute form resolves through molpal/__init__.py, which does `from .explorer import
# Explorer` and pulls in ray, torch and pytorch_lightning. The relative import keeps this
# module standalone so AFVS needs no molpal install on the head node.
